...
export async function GET() {
  const baseUrl = (process.env.NEXT_PUBLIC_SITE_URL || 'https://attack-on-titan-revolution.wiki').replace(/\/$/, '')
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Attack on Titan Revolution Wiki'
